      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between">
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm text-gray-900 placeholder-gray-500"
            />
        ...
        <div className="flex gap-4">
          <FilterDropdown 
            ...
            value={roleFilter}
            onChange={setRoleFilter} // Truyền hàm từ cha vào thẳng đây
          />
