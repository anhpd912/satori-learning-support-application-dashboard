...
interface ImportAIClientProps {
    courseId: string;
}

export default function ImportAIClient({ courseId }: ImportAIClientProps) {
    ...
    const handleConfirmUpload = async () => {
        ...
        try {
            await curriculumImportService.initiateImport(file, courseId);
        ...
        <div className="p-8 bg-gray-50 min-h-screen font-sans w-full flex flex-col">
            ...
            <PageHeader
                breadcrumb={[
                    ...
                    { label: 'Chi tiết khóa học', href: `/courses/${courseId}` },
                    { label: 'Quản lý bài học', href: `/courses/${courseId}/lessons` },
                    { label: 'Nhập giáo trình AI', active: true }
                ]}
